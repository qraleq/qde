...
% SKRATITI OVO, DOSTA NEPOTREBNOG OBJAŠNJAVANJA
...
\begin{figure}
	...
	\begin{tikzpicture}
	\node[anchor=center, inner sep = 0](rec1) at (0,0)
	{\includegraphics[width=4.3cm]{figures/flip_test_reconstruction_normal.pdf}};
	
	\node[anchor=center, inner sep = 0](rec1) at (4.5,0)
	{\includegraphics[width=4.3cm]{figures/flip_test_reconstruction_flip.pdf}};
	\end{tikzpicture}
...
\begin{figure}
	...
	\begin{tikzpicture}
	\node[anchor=center](rec1) at (0,0)
	{\includegraphics[width=8cm]{figures/temporal_cs.png}};
	\end{tikzpicture}
